<div id="content_sec">
        ...
        <div class="col1">
            ...
            <div class="allvideos_heading">
            	<h1>'Lights Out' is main event on FX</h1>
                <p class="txt">(OFFICIAL)</p>
            </div>
            <div class="clear"></div>
            <!-- Video Detail -->
            <div class="videodetail">
                ...
                <div class="shortdetail">
                	<div class="videoby">
                        ...
                        <p>By</p>
                        <a href="#" class="bold name">Rihanna</a>
                    </div>
                ...
                <!-- Big Video -->
                <div class="videobig">
                	<object type="application/x-shockwave-flash" style="width:675px; height:438px;" data="http://www.youtube.com/v/X9_n8jakvWU?fs=1&amp;hl=en_US&amp;rel=0">
